            ...
            >
              ...
              <form className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => {
                    const message = "Hi, I'd like to get a free quote from Peiris Cleaning Solutions";
                    window.open(
                      `https://wa.me/447903599828?text=${encodeURIComponent(message)}`,
                      "_blank"
                    );
                  }}
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Or call us directly at <a href="tel:07903599828" className="text-primary font-semibold hover:underline">07903 599828</a>
                </p>
              </form>
            </motion.div>
          </motion.div>
